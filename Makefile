...
kind-platform-managed-configmap-properties-fast-e2e:
	KIND_CLUSTER_NAME=nifi-fabric-platform-configmap-properties FAST_PROFILE=true bash hack/kind-platform-managed-configmap-properties-e2e.sh

kind-platform-managed-configmap-properties-fast-e2e-reuse:
	KIND_CLUSTER_NAME=nifi-fabric-platform-configmap-properties FAST_PROFILE=true SKIP_KIND_BOOTSTRAP=true bash hack/kind-platform-managed-configmap-properties-e2e.sh
