...
- Secret-backed repository encryption through a dedicated chart surface
...
- bounded flow-change audit with NiFi-native local history plus an optional log-only reporter export path
